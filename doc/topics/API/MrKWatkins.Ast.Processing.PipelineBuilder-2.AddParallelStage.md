...
Adds a stage to the pipeline with the specified [Processors](MrKWatkins.Ast.Processing.Processor-2.md) to be run in parallel. Its name will be the number of the stage.
