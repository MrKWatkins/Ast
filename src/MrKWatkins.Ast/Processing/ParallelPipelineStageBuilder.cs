    ...
    where TNode : Node<TNode>
{
    ...
    [Pure]
    internal override PipelineStage<TNode> Build()
    {
        return new PipelineStage<TNode>(Name, [new ParallelProcessor<TNode>(Processors, maxDegreeOfParallelism)], ShouldContinue);
    }
